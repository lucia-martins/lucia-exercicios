...
function calcular() {
    ...
    frase.innerHTML = `Uma pessoa que fuma ${quant} cigarro por dia, há ${anos} anos já <strong>perdeu ${horas.toFixed(1)} horas de vida</strong>! Isso corresponde a ${dias.toFixed(1)} dias a menos.`
